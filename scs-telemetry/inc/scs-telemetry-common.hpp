...
#ifndef SCS_TELEMETRY_INC_SCS_TELEMETRY_COMMON_HPP_
#define SCS_TELEMETRY_INC_SCS_TELEMETRY_COMMON_HPP_
...
typedef struct scsTelemetryMap_s {
    ...
    // The second zone contains uint's and it sorted in sub structures
    ...
    struct {
        ...
        // Game identifier, see defines at the top of this file
        unsigned int game;
    ...
    // The 14th zone contains values of up to 10 trailers
    struct {
...
#endif  // SCS_TELEMETRY_INC_SCS_TELEMETRY_COMMON_HPP_
